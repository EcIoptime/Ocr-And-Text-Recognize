        ...
        fun process(Imagem: Bitmap): Bitmap {
            ...
            for (i in 2 until width - 2) {
                for (j in 2 until height - 2) {
                    val red = (allPixR[i - 2][j - 2] + allPixR[i - 1][j - 2] * 4 + allPixR[i][j - 2] * 7 + allPixR[i + 1][j - 2] * 4 + allPixR[i + 2][j - 2]
                            + allPixR[i - 2][j - 1] * 4 + allPixR[i - 1][j - 1] * 16 + allPixR[i][j - 1] * 26 + allPixR[i + 1][j - 1] * 16 + allPixR[i + 2][j - 1] * 4 + allPixR[i - 2][j] * 7 + allPixR[i - 1][j] * 26 + allPixR[i][j] * 41 + allPixR[i + 1][j] * 26 + allPixR[i + 2][j] * 7 + allPixR[i - 2][j + 1] * 4 + allPixR[i - 1][j + 1] * 16 + allPixR[i][j + 1] * 26 + allPixR[i + 1][j + 1] * 16 + allPixR[i + 2][j + 1] * 4 + allPixR[i - 2][j + 2] + allPixR[i - 1][j + 2] * 4 + allPixR[i][j + 2] * 7 + allPixR[i + 1][j + 2] * 4 + allPixR[i + 2][j + 2]) / 273
                    val green = (allPixG[i - 2][j - 2] + allPixG[i - 1][j - 2] * 4 + allPixG[i][j - 2] * 7 + allPixG[i + 1][j - 2] * 4 + allPixG[i + 2][j - 2]
                            + allPixG[i - 2][j - 1] * 4 + allPixG[i - 1][j - 1] * 16 + allPixG[i][j - 1] * 26 + allPixG[i + 1][j - 1] * 16 + allPixG[i + 2][j - 1] * 4 + allPixG[i - 2][j] * 7 + allPixG[i - 1][j] * 26 + allPixG[i][j] * 41 + allPixG[i + 1][j] * 26 + allPixG[i + 2][j] * 7 + allPixG[i - 2][j + 1] * 4 + allPixG[i - 1][j + 1] * 16 + allPixG[i][j + 1] * 26 + allPixG[i + 1][j + 1] * 16 + allPixG[i + 2][j + 1] * 4 + allPixG[i - 2][j + 2] + allPixG[i - 1][j + 2] * 4 + allPixG[i][j + 2] * 7 + allPixG[i + 1][j + 2] * 4 + allPixG[i + 2][j + 2]) / 273
                    val blue = (allPixB[i - 2][j - 2] + allPixB[i - 1][j - 2] * 4 + allPixB[i][j - 2] * 7 + allPixB[i + 1][j - 2] * 4 + allPixB[i + 2][j - 2]
                            + allPixB[i - 2][j - 1] * 4 + allPixB[i - 1][j - 1] * 16 + allPixB[i][j - 1] * 26 + allPixB[i + 1][j - 1] * 16 + allPixB[i + 2][j - 1] * 4 + allPixB[i - 2][j] * 7 + allPixB[i - 1][j] * 26 + allPixB[i][j] * 41 + allPixB[i + 1][j] * 26 + allPixB[i + 2][j] * 7 + allPixB[i - 2][j + 1] * 4 + allPixB[i - 1][j + 1] * 16 + allPixB[i][j + 1] * 26 + allPixB[i + 1][j + 1] * 16 + allPixB[i + 2][j + 1] * 4 + allPixB[i - 2][j + 2] + allPixB[i - 1][j + 2] * 4 + allPixB[i][j + 2] * 7 + allPixB[i + 1][j + 2] * 4 + allPixB[i + 2][j + 2]) / 273
