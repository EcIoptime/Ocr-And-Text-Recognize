...
//            }
            ...
            Log.i("hello" ," sucess called")
            objectDetectorListener.onInitialized()
        }.addOnFailureListener{
            Log.i("hello" ," sucess called $it")
    ...
    fun setupObjectDetector() {
        if (!TfLiteVision.isInitialized()) {
            Log.i(TAG, "setupObjectDetector: TfLiteVision is not initialized yet")
            return
        }
...
//        val builder: NormalizationOptions.Builder = Builder()
//        builder.setMean(floatArrayOf(0.485f, 0.456f, 0.406f))
//        builder.setStd(floatArrayOf(0.229f, 0.224f, 0.225f))
//        val normalizationOptions: NormalizationOptions = builder.build()
...
//                    baseOptionsBuilder.useGpu()
    ...
    fun detect(image: Bitmap, imageRotation: Int): MutableList<Detection> {
        ...
        objectDetectorListener.onResults(
          ...
          tensorImage.height,
          tensorImage.width)
        return results?.filterNotNull()?.toMutableList() ?: arrayListOf()
    }
